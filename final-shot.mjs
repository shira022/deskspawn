...
const SRC = '/mnt/c/Users/<user>/deskspawn-projects/preview/unit-test-002';
...
await page.screenshot({ path: '/home/<user>/hermes-project/project/deskspawn/final-preview.png' });
await browser.close();
